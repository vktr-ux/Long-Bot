...
def build_metrics(
    ...
    return Metrics(
        ...
        price_change_1m=ticker.price_change_1m_pct if ticker.price_change_1m_pct is not None else price_change_from_candles(candles_1m, 1),
        price_change_3m=ticker.price_change_3m_pct if ticker.price_change_3m_pct is not None else price_change_from_candles(candles_1m, 3),
        price_change_5m=ticker.price_change_5m_pct if ticker.price_change_5m_pct is not None else price_change_from_candles(candles_5m, 1),
        price_change_15m=ticker.price_change_15m_pct if ticker.price_change_15m_pct is not None else price_change_from_candles(candles_15m, 1),
